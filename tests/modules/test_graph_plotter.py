...
@pytest.mark.asyncio
async def test_graph_plotter_create_plot_parametric(mock_gemini_agent, tmp_path):
...
@pytest.mark.asyncio
async def test_graph_plotter_calculate_exception(mock_gemini_agent, tmp_path):
